...
public class InventoryManagementSystemDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public InventoryManagementSystemDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
