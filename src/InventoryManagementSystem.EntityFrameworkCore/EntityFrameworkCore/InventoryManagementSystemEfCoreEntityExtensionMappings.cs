...
public static class InventoryManagementSystemEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE InventoryManagementSystemModuleExtensionConfigurator CLASS (in the Domain.Shared project)
